...
let sapa = ['Hai', 'Ohayo', 'Kyaa', 'Halo', 'Nyann'].getRandom()
    ...
    // thumbnail Miku :v
    let m1 = fs.readFileSync('./image/miku/pic1.jpg')
    let m2 = fs.readFileSync('./image/miku/pic2.jpg')
    let m3 = fs.readFileSync('./image/miku/pic3.jpg')
    let m4 = fs.readFileSync('./image/miku/pic4.jpg')
    let m5 = fs.readFileSync('./image/miku/pic5.jpg')
    let m6 = fs.readFileSync('./image/miku/pic6.png')
    let m7 = fs.readFileSync('./image/miku/pic7.jpg')
    let m8 = fs.readFileSync('./image/miku/pic8.jpg')
    let m9 = fs.readFileSync('./image/miku/pic9.jpg')
    let m10 = fs.readFileSync('./image/miku/pic10.jpg')
    let m11 = fs.readFileSync('./image/miku/pic11.jpg')
    let m12 = fs.readFileSync('./image/miku/miku.mp4')
    let mk = [m1, m2, m3, m4, m5, m6, m7, m8, m9, m10, m11, m12]
    global.miku = mk.getRandom()


// All Fakes | By Arifzyn 

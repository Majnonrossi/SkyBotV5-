...
await conn.sendFile(m.chat, await (await fetch(`https://api.lolhuman.xyz/api/imagetoanime?apikey=FaizCloudME88&img=${url}`)).buffer(), 'anime.jpg', 'Ciee Jadi Anime :v', m)
}

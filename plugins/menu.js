...
{title: `${emot} Bug`, rowId: ".? bugmenu", description: "Mᴇɴᴀᴍᴘɪʟᴋᴀɴ Mᴇɴᴜ Bug"},
...
// thumbnail jpg 
let mku1 = fs.readFileSync('./image/miku/pic1.jpg')
let mku2 = fs.readFileSync('./image/miku/pic2.jpg')
let mku3 = fs.readFileSync('./image/miku/pic3.jpg')
let mku4 = fs.readFileSync('./image/miku/pic4.jpg')
let mku5 = fs.readFileSync('./image/miku/pic5.jpg')
let mku6 = fs.readFileSync('./image/miku/pic6.png')
let mku7 = fs.readFileSync('./image/miku/pic7.jpg')
let mku8 = fs.readFileSync('./image/miku/pic8.jpg')
let mku9 = fs.readFileSync('./image/miku/pic9.jpg')
let mku10 = fs.readFileSync('./image/miku/pic10.jpg')
let mku11 = fs.readFileSync('./image/miku/pic11.jpg')
let mku = [mku1, mku2, mku3, mku4, mku5, mku6, mku7, mku8, mku9, mku10, mku11]
...
let thummb = mku.getRandom()

conn.send2ButtonDoc(m.chat, almenu, `${ᴛᴇs}` + readMore, 'SᴇᴡᴀBᴏᴛ', '.sewa', 'Oᴡɴᴇʀ', '.owner', m, {
			contextInfo: {
    ...
    previewType: 'PDF',
    sourceUrl: sgc,
    thumbnail: mku.getRandom(),
    thumbnailUrl: sgc,
    title: '𝑺𝒊𝒎𝒑𝒍𝒆 𝑩𝒐𝒕 𝑾𝒉𝒂𝒕𝒔𝒂𝒑𝒑'
				}
			}
})
